...
<div class="row">
  <div class="box-dash red col m3 offset-m1 white-text z-depth-3" style="padding: 10px;">
    <h6 class="col m12 s12 right-align">Admin</h6>
    <i class="zmdi zmdi-account col m2 s12 center-align" style="font-size: 100px"></i>
